...
const ShopCommentBlock = (props: CommentBlockType) => {
    ...
    return (
        <View style={[styles.column, cm('b', 5)]}>
            <View style={[styles.row]}>
                <Image
                    source={{ uri: props.user.image }}
                    style={[styles.logo40x40, cmp('l', 10), cm('r', 5)]}
                />
                ...
                <View style={[styles.row]}>
                    <Text style={[styles.font17SBoldBlack, cmp('l', 40)]}>
                        {props.user.pk}
                    </Text>
                    <Image
                      source={require("../images/shop/yellow_star.png")}
                      style={[styles.ico15x15, cm('l', 3), cm('t', 5)]}
                    />
                </View>
            </View>
            <Text style={[styles.smallBoldText, cm('t', 10), cm('b', 15),  cmp('l', 10), {maxWidth: screenWidth*0.87}]}>
                {props.comment}
            </Text>
        </View>
    );
};
export { ShopCommentBlock };